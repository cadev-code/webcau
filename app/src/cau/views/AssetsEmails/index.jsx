...
import { addSite, deleteSite, updateSite } from '../../api/assetsEmails.api'

export const AssetsEmails = ({userData}) => {

  const [userIsAdmin, setUserIsAdmin] = useState(false)

  useEffect(() => {
    setUserIsAdmin(userData.permissions.includes('emails_assets'))
  }, [userData])
